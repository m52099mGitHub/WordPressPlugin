...
/**
 * Plugin Name:Dashboard for Different Login User Testing Copy 2
    ...
    class dashboard_menu_adjust
    {
        ...
        public function dashboard_menu_display()
        {
            ...
            if (username_exists($userNameInput)) {
                ...
                if ($currentUserName  == $userNameInput) { //若当前登录用户名是Colin,则不执行后续语句。若不是则对管理员用户Admin和Colin以外的以外的用户隐藏下面的菜单内容
