...
/**
 * Plugin Name:Dashboard for Different Login User Testing Copy 3
    ...
    class dashboard_menu_adjust
    {
        ...
        public function dashboard_menu_display()
        {
            ...
            if (username_exists($userNameInput)) {
                ...
                // echo '<p style="text-align:center; color:#E66;">用户:' . $userNameInput . '已注册, 他是' .$userLevel. '级用户, ID为' . $userId .', 已授权成功</p>';
