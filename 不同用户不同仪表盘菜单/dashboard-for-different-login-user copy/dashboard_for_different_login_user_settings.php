                    ...
                    <table id="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="userRole" name="userRole" type="text" value="<?php _e('请输入已注册用户名', 'dashboard-for-different-login-user'); ?>">
                                <?php
                                $opt = get_option($currentUserName.'_set_display_item_for_user_options');
                                // print_r($opt);
                                // //获取输入的用户名
                                ...
                                if (username_exists($userNameInput)) {
                                    ...
                                    echo '<p id="tip" style="width: 150px; color:red;text-align:right; margin-left:350px;">' . $userNameInput . '已注册, 他是' . $userLevel . '级用户, ID为' . $userId . ', 可以向他授权可查看菜单</p>';
                                } else {
